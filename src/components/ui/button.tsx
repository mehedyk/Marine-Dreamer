  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Ocean School custom variants
        pill: "rounded-full bg-foreground/10 backdrop-blur-md border border-foreground/20 text-foreground hover:bg-foreground/20 hover:border-foreground/30",
        ocean: "rounded-full bg-primary text-primary-foreground hover:bg-primary/80 shadow-[0_0_30px_hsl(199_89%_48%/0.4)] hover:shadow-[0_0_40px_hsl(199_89%_48%/0.6)]",
      },
      size: {
